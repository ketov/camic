...
},function(module,exports,__webpack_require__){__webpack_require__(3)(__webpack_require__(8))},function(module,exports){module.exports='"use strict";\n\nvar _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };\n\n/*\n* jquery-match-height 0.7.0 by @liabru\n* http://brm.io/jquery-match-height/\n* License MIT\n*/\n!function (t) {\n  "use strict";\n  "function" == typeof define && define.amd ? define(["jquery"], t) : "undefined" != typeof module && module.exports ? module.exports = t(require("jquery")) : t(jQuery);\n}(function (t) {\n  var e = -1,\n      o = -1,\n      i = function i(t) {\n    return parseFloat(t) || 0;\n  },\n      a = function a(e) {\n    var o = 1,\n        a = t(e),\n        n = null,\n        r = [];return a.each(function () {\n      var e = t(this),\n          a = e.offset().top - i(e.css("margin-top")),\n          s = r.length > 0 ? r[r.length - 1] : null;null === s ? r.push(e) : Math.floor(Math.abs(n - a)) <= o ? r[r.length - 1] = s.add(e) : r.push(e), n = a;\n    }), r;\n  },\n      n = function n(e) {\n    var o = {\n      byRow: !0, property: "height", target: null, remove: !1 };return "object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) ? t.extend(o, e) : ("boolean" == typeof e ? o.byRow = e : "remove" === e && (o.remove = !0), o);\n  },\n      r = t.fn.matchHeight = function (e) {\n    var o = n(e);if (o.remove) {\n      var i = this;return this.css(o.property, ""), t.each(r._groups, function (t, e) {\n        e.elements = e.elements.not(i);\n      }), this;\n    }return this.length <= 1 && !o.target ? this : (r._groups.push({ elements: this, options: o }), r._apply(this, o), this);\n  };r.version = "0.7.0", r._groups = [], r._throttle = 80, r._maintainScroll = !1, r._beforeUpdate = null, r._afterUpdate = null, r._rows = a, r._parse = i, r._parseOptions = n, r._apply = function (e, o) {\n    var s = n(o),\n        h = t(e),\n        l = [h],\n        c = t(window).scrollTop(),\n        p = t("html").outerHeight(!0),\n        d = h.parents().filter(":hidden");return d.each(function () {\n      var e = t(this);e.data("style-cache", e.attr("style"));\n    }), d.css("display", "block"), s.byRow && !s.target && (h.each(function () {\n      var e = t(this),\n          o = e.css("display");"inline-block" !== o && "flex" !== o && "inline-flex" !== o && (o = "block"), e.data("style-cache", e.attr("style")), e.css({ display: o, "padding-top": "0",\n        "padding-bottom": "0", "margin-top": "0", "margin-bottom": "0", "border-top-width": "0", "border-bottom-width": "0", height: "100px", overflow: "hidden" });\n    }), l = a(h), h.each(function () {\n      var e = t(this);e.attr("style", e.data("style-cache") || "");\n    })), t.each(l, function (e, o) {\n      var a = t(o),\n          n = 0;if (s.target) n = s.target.outerHeight(!1);else {\n        if (s.byRow && a.length <= 1) return void a.css(s.property, "");a.each(function () {\n          var e = t(this),\n              o = e.attr("style"),\n              i = e.css("display");"inline-block" !== i && "flex" !== i && "inline-flex" !== i && (i = "block");var a = {\n            display: i };a[s.property] = "", e.css(a), e.outerHeight(!1) > n && (n = e.outerHeight(!1)), o ? e.attr("style", o) : e.css("display", "");\n        });\n      }a.each(function () {\n        var e = t(this),\n            o = 0;s.target && e.is(s.target) || ("border-box" !== e.css("box-sizing") && (o += i(e.css("border-top-width")) + i(e.css("border-bottom-width")), o += i(e.css("padding-top")) + i(e.css("padding-bottom"))), e.css(s.property, n - o + "px"));\n      });\n    }), d.each(function () {\n      var e = t(this);e.attr("style", e.data("style-cache") || null);\n    }), r._maintainScroll && t(window).scrollTop(c / p * t("html").outerHeight(!0)), this;\n  }, r._applyDataApi = function () {\n    var e = {};t("[data-match-height], [data-mh]").each(function () {\n      var o = t(this),\n          i = o.attr("data-mh") || o.attr("data-match-height");i in e ? e[i] = e[i].add(o) : e[i] = o;\n    }), t.each(e, function () {\n      this.matchHeight(!0);\n    });\n  };var s = function s(e) {\n    r._beforeUpdate && r._beforeUpdate(e, r._groups), t.each(r._groups, function () {\n      r._apply(this.elements, this.options);\n    }), r._afterUpdate && r._afterUpdate(e, r._groups);\n  };r._update = function (i, a) {\n    if (a && "resize" === a.type) {\n      var n = t(window).width();if (n === e) return;e = n;\n    }i ? -1 === o && (o = setTimeout(function () {\n      s(a), o = -1;\n    }, r._throttle)) : s(a);\n  }, t(r._applyDataApi), t(window).bind("load", function (t) {\n    r._update(!1, t);\n  }), t(window).bind("resize orientationchange", function (t) {\n    r._update(!0, t);\n  });\n});'},function(module,exports){"use strict";$(document).ready(function(){function circle(){var height=$(".circle").width();$(".circle").each(function(){$(this).css({height:height})})}function circle2(){var height=$(".circle-2").width();$(".circle-2").each(function(){$(this).css({height:height})})}$(".login").on("click",function(){var top=$(window).scrollTop()+140;return $(".login-popup").css({top:top}),$(".black-bg").fadeIn(400),setTimeout(function(){$(".login-popup").fadeIn(400)},480),!1}),$(".login-popup__close").on("click",function(){$(".login-popup").fadeOut(400),setTimeout(function(){$(".black-bg").fadeOut(400)},480)}),$(".blue-block__button").on("click",function(){var el=$(this),show=el.parent(".text").children(".hidden");show.length>0&&(el.hasClass("button--active")?(show.slideUp(200),el.removeClass("button--active"),el.text("Continua a leggere")):(show.slideDown(200),el.addClass("button--active"),el.text("Chiudi")))}),$(".search-white").on("click",function(){var el=$(this),input=el.siblings("form").children("input");input.hasClass("active")?input.removeClass("active"):input.addClass("active")}),circle(),circle2(),$(window).resize(function(){circle(),circle2()});var timer,body=$("body"),windowHeight=$(window).height(),windowWidth=$(window).width(),setHeight=function(){};setHeight(),$(window).bind("resize",function(){windowHeight=window.innerHeight,windowWidth=window.innerWidth,setHeight()}),$(window).bind("scroll",function(){clearTimeout(timer),body.hasClass("disable-scroll-hover")||body.addClass("disable-scroll-hover"),timer=setTimeout(function(){body.removeClass("disable-scroll-hover")},200)});try{Typekit.load({async:!0})}catch(e){}})},function(module,exports){"use strict";$(document).ready(function(){$("#hamburger").on("click",function(){$(".menu__menu").addClass("clicked");var el=$(this);el.hasClass("active")?(el.removeClass("active"),$(".menu__menu").stop(!0,!0).fadeOut(300)):(el.addClass("active"),$(".menu__menu").stop(!0,!0).fadeIn(300))})})},function(module,exports){"use strict";$(document).ready(function(){$(function(){$(".index-events__col").matchHeight({byRow:!0,property:"height",target:null,remove:!1})})})},function(module,exports){"use strict";$(document).ready(function(){$(function(){$(".text").matchHeight({byRow:!0,property:"height",target:null,remove:!1})})})},function(module,exports){"use strict";function _defineProperty(obj,key,value){return key in obj?Object.defineProperty(obj,key,{value:value,enumerable:!0,configurable:!0,writable:!0}):obj[key]=value,obj}$(document).ready(function(){var _ref;new Swiper(".index-slider__container",(_ref={slidesPerView:4,paginationClickable:!0,nextButton:".index-slider__next",prevButton:".index-slider__prev",autoplay:4e3,autoplayDisableOnInteraction:!1},_defineProperty(_ref,"paginationClickable",!0),_defineProperty(_ref,"loop",!0),_defineProperty(_ref,"breakpoints",{1190:{slidesPerView:3},1110:{slidesPerView:2},640:{slidesPerView:1}}),_ref))})},function(module,exports){"use strict";$(document).ready(function(){$(".submenu-1").on("click",function(){var el=$(this),ul=$(this).children(".submenu-1-ul");el.hasClass("active")?(ul.slideUp(50),el.removeClass("active")):(ul.slideDown(100),el.addClass("active"))}),$(".submenu-2").on("click",function(){var el=$(this),ul=$(this).children(".submenu-2-ul");return el.hasClass("active")?$(event.target).closest(".submenu-2-ul").length?void 0:(ul.slideUp(50),el.removeClass("active"),!1):(ul.slideDown(100),el.addClass("active"),!1)})})},function(module,exports){"use strict";function _defineProperty(obj,key,value){return key in obj?Object.defineProperty(obj,key,{value:value,enumerable:!0,configurable:!0,writable:!0}):obj[key]=value,obj}$(document).ready(function(){var _ref;new Swiper(".swiper-container",(_ref={slidesPerView:4,pagination:".swiper-pagination",paginationClickable:!0,nextButton:".swiper-button-next",prevButton:".swiper-button-prev",autoplay:4e3,autoplayDisableOnInteraction:!1},_defineProperty(_ref,"paginationClickable",!0),_defineProperty(_ref,"loop",!0),_defineProperty(_ref,"breakpoints",{1190:{slidesPerView:3},1110:{slidesPerView:2},640:{slidesPerView:1}}),_ref))})},function(module,exports){"use strict";function _defineProperty(obj,key,value){return key in obj?Object.defineProperty(obj,key,{value:value,enumerable:!0,configurable:!0,writable:!0}):obj[key]=value,obj}$(document).ready(function(){var _ref;new Swiper(".slide-2",(_ref={slidesPerView:5,paginationClickable:!0,nextButton:".swiper-2-button-next",prevButton:".swiper-2-button-prev",autoplay:4e3,autoplayDisableOnInteraction:!1},_defineProperty(_ref,"paginationClickable",!0),_defineProperty(_ref,"loop",!0),_defineProperty(_ref,"spaceBetween",30),_defineProperty(_ref,"breakpoints",{1190:{slidesPerView:3},1110:{slidesPerView:2},640:{slidesPerView:1}}),_ref));$(".swiper-2").fancybox({showNavArrows:!0})})},function(module,exports){"use strict";$(document).ready(function(){$(function(){$(".event-col").matchHeight({byRow:!0,property:"height",target:null,remove:!1})}),$(".associate__block").on("click",function(){var top=$(window).scrollTop()+40;return $(".associate-popup").css({top:top}),$(".black-bg").fadeIn(400),setTimeout(function(){$(".associate-popup").fadeIn(400)},480),!1}),$(".close-associate").on("click",function(){$(".associate-popup").fadeOut(400),setTimeout(function(){$(".black-bg").fadeOut(400)},480)})})},function(module,exports){"use strict";$(document).ready(function(){$(function(){$(".event-col").matchHeight({byRow:!0,property:"height",target:null,remove:!1})}),$(".p-events").length>0&&($("#calendar").fullCalendar({eventSources:[{events:[{title:"event1",start:"2017-05-01",className:"event-1"},{title:"event2 sadf asdf asf adsf as fas f",start:"2017-05-05",className:"event-2"},{title:"event3",start:"2017-05-09",className:"event-3"}],color:"#000",textColor:"yellow"}]}),$(".calendarEvent").on("click",function(){var thisButton=$(this),thisButtonEvent=thisButton.data("event");$(".event-active").removeClass("event-active"),$("."+thisButtonEvent).addClass("event-active");var top=$(window).scrollTop()+40;$("#calendar").css({top:top}),$(".black-bg").fadeIn(400),setTimeout(function(){$("#calendar").fadeIn(400)},480)}),$(".icon-container--calendar").on("click",function(){$(".event-active").removeClass("event-active");var top=$(window).scrollTop()+40;$("#calendar").css({top:top}),$(".black-bg").fadeIn(400),setTimeout(function(){$("#calendar").fadeIn(400)},480)}),setTimeout(function(){$("#calendar").hide()},1400),setTimeout(function(){$("#calendar").css({opacity:1,"z-index":3})},1800),$(".black-bg").click(function(event){$(event.target).closest("#calendar").length||($("#calendar").fadeOut(600),setTimeout(function(){$(".black-bg").fadeOut(400)},600))}))})},function(module,exports){"use strict";$(document).ready(function(){$(".member-to-member-button").on("click",function(){var top=$(window).scrollTop()+40;return $(".member-to-member-popup").css({top:top}),$(".black-bg").fadeIn(400),setTimeout(function(){$(".member-to-member-popup").fadeIn(400)},480),!1}),$(".close-member-to-member").on("click",function(){$(".member-to-member-popup").fadeOut(400),setTimeout(function(){$(".black-bg").fadeOut(400)},480)})})},function(module,exports){"use strict";$(document).ready(function(){$(".partner").on("click",function(){var top=$(window).scrollTop()+40;return $(".partner-popup").css({top:top}),$(".black-bg").fadeIn(400),setTimeout(function(){$(".partner-popup").fadeIn(400)},480),!1}),$(".close-parnters").on("click",function(){$(".partner-popup").fadeOut(400),setTimeout(function(){$(".black-bg").fadeOut(400)},480)})})},function(module,exports){"use strict";$(document).ready(function(){})}]);